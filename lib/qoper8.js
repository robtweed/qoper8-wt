...
var qoper8 = function() {
  ...
  this.worker = {
    ...
    poolSize: 1,
    loaderFilePath: './node_modules/qoper8-wt-worker.js',
  ...
  this.on('workerStarted', function(threadId, customQueue) {
    if (this.log) console.log('New Worker Thread ' + threadId + ' started and ready, so processing queue again');
...
proto.getWorkerThreadIds = require('./master/proto/getWorkerThreadIds');
...
var workerProcess = function(params) {
  this.moduleName = 'qoper8-wt Worker Thread';
  this.build = build;
  this.isFirst = false;
  this.environment = {};
  this.count = 0;
